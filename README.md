...
You should be able to install this as a *module* within  Foundry VTT, but installing the [manifest](https://raw.githubusercontent.com/chrisesharp/foundryvtt-owb-ponteville/master/world.json)
